import{j as e,ad as N,ae as E,r as c,af as T,ag as A,ah as P,ai as O,aj as F,w as v,ak as $,al as V,n as R,am as z,an as I,ao as B,ap as L,aq as W,ar as H}from"./vendor-C811conn.js";import{G as _}from"./index-Bxd2NXSN.js";T.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose",themeVariables:{background:"transparent"}});function G({chartCode:t}){const[a,n]=c.useState(""),[r,u]=c.useState(null);return c.useEffect(()=>{let i=!0;const m="mermaid-render-"+Math.random().toString(36).substring(2,11);async function p(){try{u(null);const s=t.replace(/\u00a0/g," ").replace(/\r/g,`
