    ...
    >
      ...
      <main className="px-6 max-w-7xl mx-auto pb-32 space-y-28">
        ...
        <section className="w-full text-center py-12 border-t border-white/10">
          <h2 className="text-2xl font-black mb-2">Have a technology challenge?</h2>
          <p className="text-gray-400 text-sm mb-6">Reach out directly or complete the service request questionnaire to open a consultation / discovery session.</p>
          <a
            href="/#/request"
